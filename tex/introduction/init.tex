...
% TODO
% However, a more sophisticated compression method, or probability model
% that cloudy days often follow rainy days.
% If the ...
% does not match
% then the "compressed" result will be inefficient
% For instance,
% ...
% Good compression requires accurate modeling of the data source.
% probability models.
% adapt probability model dynamically
% adapt to changing weather
% seasons
% or to changing climate patterns
% or to other patterns (e.g. rainy days often follow cloudy days)
%
% More generally, any encoding probability distribution can be
% perfectly coded using an arithmetic coder
